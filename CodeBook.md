Data set:
=========================================
The Data set based on http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones.

Process Run on Dataset:
-----------------------
...
The columns in the tidy dataset include
=================================
- activity
- subject
- tBodyAcc-mean()-X
